...
| 名前              | データ型 | 制約          | 説明                             |
| ----------------- | -------- | ------------- | -------------------------------- |
| `product_id`      | INT      | PRIMARY KEY   | 製品のユニークID                 |
| `name`            | TEXT     | NOT NULL      | 製品名                           |
| `model_number`    | TEXT     |               | 型番                             |
| `category_id`     | INT      | FOREIGN KEY   | 分類のID（Categoryへの外部キー） |
| `owner_id`        | INT      | FOREIGN KEY   | 所有者（Userへの外部キー）       |
| `cost`            | INT      |               | 製品の購入コスト                 |
...
| 名前              | データ型 | 制約             | 説明                                        |
| ----------------- | -------- | ---------------- | ------------------------------------------- |
| `user_id`         | INT      | PRIMARY KEY      | ユーザーのユニークID                        |
...
| 名前           | データ型  | 制約                      | 説明                              |
| -------------- | --------- | ------------------------- | --------------------------------- |
| `request_id`   | INT       | PRIMARY KEY               | 申請のユニークID                  |
| `applicant_id` | INT       | FOREIGN KEY               | 申請者のID（Userへの外部キー）    |
...
| 名前          | データ型 | 制約             | 説明                 |
| ------------- | -------- | ---------------- | -------------------- |
| `category_id` | INT      | PRIMARY KEY      | カテゴリのユニークID |
